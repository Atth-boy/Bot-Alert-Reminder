...
5. ตั้ง **API_SECRET** (passcode สำหรับกัน abuse):
   - เปิด **Project Settings → Script Properties → Add property**
   - Name: `API_SECRET`, Value: ตั้งรหัสยาวๆ เช่น `my-pass-12345`
...
2. ไปที่ **Settings → Secrets and variables → Actions** เพิ่ม secrets:
   | Name | Value |
   |---|---|
   | `GAS_WEB_APP_URL` | URL จากข้อ 1.6 |
   | `LINE_CHANNEL_ACCESS_TOKEN` | Token จากข้อ 2.3 |
   | `API_SECRET` | รหัสเดียวกับที่ตั้งใน GAS Script Properties |
